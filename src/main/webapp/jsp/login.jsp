...
<div class="login-wrap">
  <s:form method="post" action="login" namespace="/" theme="simple" name="loginForm">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="25" valign="bottom">用户名：</td>
    </tr>
    <tr>
      <td><s:textfield name="userName" theme="simple" class="login_input login_user"/>
      <!--  <input type="text" class="login_input login_user" value="admin" /> -->
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td><s:password  name="passWord" theme="simple" class="login_input login_password"/>
      <!-- <input type="password"  class="login_input login_password" value="12345678" />-->
      </td>
    </tr>
    <tr>
